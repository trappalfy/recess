...
export function Cta() {
  ...
  return (
    /* Height stops where the footer row begins (main brief 6.5: socials centred
       ...
       past the footer to the page edge, as on the reference. */
    <div className="relative" style={{ height: u(755) }} data-testid="cta">
      <motion.div
